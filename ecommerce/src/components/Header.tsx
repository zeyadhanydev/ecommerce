...
const Header = () => {
  ...
  return (
    <header className="bg-brand-white/80 backdrop-blur-sm sticky top-0 z-40">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-24">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link to={isAuthenticated ? "/account" : "/login"} className="text-brand-black hover:text-brand-black/70 transition-colors">
      ...
      {isMenuOpen && (
        <div className="lg:hidden absolute top-24 left-0 w-full bg-brand-white shadow-lg">
